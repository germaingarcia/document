...
\textbf{Índice de Dunn $(Du)$}. El índice de Dunn \cite{xu2009clustering} es una medida de calidad para una clusterización que sirve para medir cuan compactos y separados son un conjunto de clusters. $(Du)$ se define como:
\begin{equation}
...
Naturalmente Radviz tiene ciertos inconvenientes como la sobreposición de los datos y la poca facilidad de exploración cuando se trata de conjunto de datos de muy alta dimensión, como se muestra en la figura \ref{fig:Radviz}.
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.8\columnwidth]{figs/StarCoordinates}%
\caption{Star Coordinates ...}%
\label{fig:StarCoordinates}%
\end{figure}
